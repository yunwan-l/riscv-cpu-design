...
echo ============================================================
echo   RVP Pipeline Forwarding Test - One-Click Build
...
if "!VIVADO!"=="" (
    ...
    echo   source C:/rvp_proj/synth/vivado/build_forward.tcl
    pause
    exit /b 1
)
...
rem ============================================================
rem Clean up stale synthesis state
rem ============================================================
...
"!VIVADO!" -mode batch -source "C:\rvp_proj\synth\vivado\build_forward.tcl" -log "C:\rvp_proj\build\vivado\build_forward.log" -journal "C:\rvp_proj\build\vivado\build_forward.jou"
...
if not errorlevel 1 (
    ...
    echo.
    echo   Expected: LED 11 (0x0800) blinks at ~15Hz
    echo   7-seg display shows delay loop PC address
) else (
    echo   BUILD FAILED! Check the log:
    echo   C:\rvp_proj\build\vivado\build_forward.log
)
echo ============================================================
pause
