...
HD_PWD='C:/rvp_proj/build/vivado_piano/rvp_piano.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rvp_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rvp_fpga_top.tcl
