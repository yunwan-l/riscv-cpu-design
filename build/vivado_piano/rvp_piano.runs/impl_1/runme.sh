...
HD_PWD='C:/rvp_proj/build/vivado_piano/rvp_piano.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rvp_fpga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rvp_fpga_top.tcl -notrace
